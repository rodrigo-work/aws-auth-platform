...
export class AuthController extends AbstractController {
  ...
  public async statusAuth(req: Request, res: Response): Promise<void> {
    try {
      const message: string = await this.cognitoService.getStatus()
  ...
  public async login(req: Request, res: Response): Promise<void> {
    ...
    try {
      const result = await this.cognitoService.authenticateUser(email, password)
